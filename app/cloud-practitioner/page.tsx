...
export default function CloudPractitionerOverview() {
    ...
    const securityAndComplianceCount = {
        ...
        subdomains: {
            responsibilityModel: cloudPractitionerSharedResponsibilityModel.length,
    ...
    const technologyCount = {
        ...
        subdomains: {
            deployingOperating: cloudPractitionerDeployingOperating.length,
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl mx-auto bg-gray-800 p-6 shadow-lg rounded-lg text-center">
                    ...
                    <p className="text-lg text-gray-300 mb-6">
                        Prepare for the AWS Certified Cloud Practitioner exam by tackling questions specifically designed to simulate the real test experience.
                    </p>
                </div>
                ...
                <div className="max-w-3xl mx-auto bg-gray-100 text-gray-800 p-6 shadow-lg rounded-lg mt-8">
                    ...
                    <ul className="list-disc ml-5 text-gray-700 mb-4">
                        <li><strong>Definition of AWS Cloud:</strong> ({cloudConceptsCount.subdomains.definition})</li>
                    ...
                    <ul className="list-disc ml-5 text-gray-700 mb-4">
                        <li><strong>Shared Responsibility Model:</strong> ({securityAndComplianceCount.subdomains.responsibilityModel})</li>
                        ...
                        <li><strong>Security Support Resources:</strong> ({securityAndComplianceCount.subdomains.supportResources})</li>
                    </ul>
                    ...
                    <ul className="list-disc ml-5 text-gray-700 mb-4">
                        <li><strong>Deploying and Operating:</strong> ({technologyCount.subdomains.deployingOperating})</li>
                    ...
                    {/* Billing and Pricing */}
                    <h3 className="text-lg font-semibold mb-2">4. Billing and Pricing</h3>
                    <p className="text-gray-700 mb-4">
